    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        pwdET = ((EditText) hasViews.findViewById(id.login_et_pwd));
        loginButton = ((Button) hasViews.findViewById(id.login_btn));
        accountET = ((EditText) hasViews.findViewById(id.login_et_account));
        if (loginButton!= null) {
